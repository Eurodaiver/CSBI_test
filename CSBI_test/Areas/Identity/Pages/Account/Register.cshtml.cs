...
namespace CSBI_test.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Manager { UserName = Input.Email, Email = Input.Email, SurName = Input.SurName, Position = Input.Position, Name = Input.Name };
